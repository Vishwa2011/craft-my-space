    ...
    <>
       ...
       <div
          ...
          <div className='container mx-auto px-4'>
              <div>
                  <h2 className="text-2xl md:text-3xl font-bold mb-4" style={{marginBottom:'20px'}}>Terms & Conditions</h2>
              </div>
              <div>
                   <h4>1.The Contract</h4>
                   <ul style={{lineHeight:'30px'}}>
                    <li>These terms and conditions form the legally binding agreement between Craftmyspace Interiors Ltd “the Company” and the person signing the contract/agreeing verbally/placing the order referred to as “the Customer”. The Company Registration Number 11976914 is registered at address is Unit 9 Slough Interchange, Whittenham Close, Slough SL2 5EP. Nothing in this agreement shall affect your statutory rights and it is the Customer’s responsibility to ensure all details are correct. </li>
                    ...
                    <li>In the event any work, materials or services are requested by any third party (which includes but is not limited to any builders, contractors, interior designers or any other person who is in the Customer’s house or who the Company reasonably believes is acting for and on behalf of the Customer) then the third party will be held responsible and liable for the agreement.</li>
                   </ul>
              </div>
              <div>
                ...
                <ul style={{lineHeight:'30px'}}>
                    ...
                    <li>Installation of appliances, plumbing, gas fitting and electrics.</li>
                    <li>Any damage done to the electrical wiring and plumbing inside the walls during fitting.</li>
                </ul>
              </div>
              <div>
                ...
                <ul style={{lineHeight:'30px'}}>
                    ...
                    <li>Notify our technical surveying department of the whereabouts (if known) of hidden pipes or wires that may affect the proposed layout.</li>
                    <li>Move any fragile or valuable items, which could be damaged when carrying new units/appliances into the property.</li>
                    <li>Shortages or damages should be notified to the company within a reasonable time (up to 5 working days) by telephone on or after receipt of the goods.</li>
              ...
              <div>
                ...
                <ul style={{lineHeight:'30px'}}>
                    ...
                    <li>All prices excluding VAT unless otherwise stated.</li>
                </ul>
              </div>
              <div>
                ...
                <ul style={{lineHeight:'30px'}}>
                    ...
                    <li>If you are unable, for whatever reason, to take delivery of your goods on the confirmed delivery date, you must notify the company beforehand otherwise we reserve the right to charge you for any subsequent delivery costs.</li>
              ...
              <div>
                ...
                <ul style={{lineHeight:'30px'}}>
                    ...
                    <li>The guarantee excludes damage for which you are to blame i.e. the effects of external force or water damage</li>
                    <li>To make a claim, simply contact us in writing, by telephone or e-mail and we will directly find a solution together with you. By emailing and attaching a photo, we can act fast and straight away see what needs to be done.</li>
                    <li>Please note sliding wardrobe systems are equipped with bottom mounted wheels to ensure smooth and easy operation and carry a 10-year rolling gear guarantee. Mirror silvering is guaranteed for 10 years from installation and workmanship is guaranteed for 12 months following installation.</li>

                    <li>We use 18mm high-density melamine face boards (MFC) for carcases and backing to ensure stronger construction for 15 to 20 years. But we can only guarantee structure for 10 years.</li>
              ...
              <div>
                ...
                <ul style={{lineHeight:'30px'}} >
                    ...
                    <li>Some panels are produced in decorative materials – particularly Gloss finishes – and therefore can be easily damaged and should be protected against marking. The Company is not responsible for any marking caused to any panels after installation</li>
                    <li>To make a claim, simply contact us in writing, by telephone or e-mail and we will directly find a solution together with you. By emailing and attaching a photo, we can act fast and straight away see what needs to be done.</li>
                    <li>The Customer is responsible to ensure that where necessary any planning consents or building regulations are obtained in respect of any goods provided under this agreement.</li>
                    <li>Natural wood is used in some of our products and fitted wardrobes. As a natural material wood reflects the endless variety of grains, shades and textures found in the nature and such variances can be expected. All timber products will mellow under exposure of time. PVC, laminates and melamine finishes are also subject to slight colour changes over a period of years. Unless specified otherwise, any reference made to wood or timber whether solid or veneered refers to door and drawer fronts only. Colour reproduction in our descriptive literature is as close as reproductive techniques allow. Laminate worktops with a textured finish give good wear and resistance, also colour fastness and heat resistance up to 120 degrees Celsius. The company cannot be responsible for burn marks caused by items in excess of this temperature. Worktops should not be subject to excessive heat or water as this could cause swelling of the joint. We strongly recommend the use of a chopping board when cutting.</li>
