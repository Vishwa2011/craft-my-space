              ...
              <div className="header-nav">
                <ul className=" nav navbar-nav">
                  ...
                  <li className="submenu-direction">
                    ...
                    <ul className="sub-menu">
                      <li>
                        <a href="work-grid.html">Recent Work</a>
                      </li>
                  ...
                  <li className="submenu-direction">
                    ...
                    <ul className="sub-menu">
                      <li>
                        <a href="work-grid.html">Get A Quote</a>
                      </li>
                      <li>
                        <a href="work-masonry.html">Order A Free Brochure</a>
                      </li>
                      <li>
                        <a href="work-carousel.html">Privacy Policy</a>
                      </li>
                      {/* <li><a href="project-detail.html">Project Detail</a></li> */}
                    </ul>
                  </li>
