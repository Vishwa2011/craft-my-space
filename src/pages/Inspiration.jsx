        ...
        <div
          ...
          <div className="section-full p-t80 p-b50 bg-gray ">
            ...
            <div className="blog-post blog-md date-style-1 clearfix bg-white"
              style={{ boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)", transition: "box-shadow 0.3s ease-in-out" }}
              onMouseEnter={(e) => e.currentTarget.style.boxShadow = "0px 6px 15px rgba(0, 0, 0, 0.2)"}
